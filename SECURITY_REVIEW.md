...
| 11 | Low | Redeeming a maliciously supplied code silently and (in-app) irreversibly links your History to a stranger — no confirmation, no unlink flow | **Open** — unlink UI is the missing piece; rules already permit it |
